...
export function SellerMachineCard({ machine }: { machine: SellerMachine }) {
  return (
      ...
      <div className="flex flex-1 flex-col p-5 sm:p-6">
        ...
        <div className="mt-auto flex items-end justify-between gap-3 pt-6">
          <div>
            ...
            <p className="mt-1 text-2xl font-black tracking-[-0.04em] text-foreground">{currencyFormatter.format(machine.basePrice)}</p>
          </div>
